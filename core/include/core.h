...
class funcs
{
    public:
        ...
        std::vector<int> (*create_wv)(int P, int V, std::vector<unsigned int>& v1, std::vector<unsigned int>& v2, std::unordered_set<unsigned int>& u1, std::unordered_set<unsigned int>& u2);
        std::unordered_set<int> (*create_wu)(int P, int V, std::vector<unsigned int>& v1, std::vector<unsigned int>& v2, std::unordered_set<unsigned int>& u1, std::unordered_set<unsigned int>& u2);
        ...
        std::vector <std::vector <std::unordered_set<unsigned int> > > (*create_Hu)(int ntsize, int V, int P);
        int (*create_P)(int V);

        funcs(void* a, void* b, void* c, void* d, void* e, void* f, void* g, void* h, void* i)
        {
            add_value  = reinterpret_cast<void(*)(std::unordered_set<unsigned int>& u, std::vector<unsigned int>& v, int a, int P)>(a);
            ...
            create_wv  = reinterpret_cast<std::vector<int>(*)(int P, int V, std::vector<unsigned int>& v1, std::vector<unsigned int>& v2, std::unordered_set<unsigned int>& u1, std::unordered_set<unsigned int>& u2)>(d);
            create_wu  = reinterpret_cast<std::unordered_set<int>(*)(int P, int V, std::vector<unsigned int>& v1, std::vector<unsigned int>& v2, std::unordered_set<unsigned int>& u1, std::unordered_set<unsigned int>& u2)>(e);
            ...
            create_Hu   = reinterpret_cast<std::vector <std::vector <std::unordered_set <unsigned int> > >(*)(int ntsize, int V, int P)>(h);
...
int output                             (int P, int V, int initial, std::vector<std::vector<std::vector<std::vector<int>> > >& prev, 
                                        std::vector <std::vector <std::vector <unsigned int> > >& H1v, std::vector<std::vector<std::unordered_set<unsigned int>>>& H1u,
                                        std::vector<int>(*create_q)(int P, std::vector<unsigned int> v));
